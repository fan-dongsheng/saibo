  ...
  <div>
    <div class="div_border">
      ...
      <div class="marginBootom">
        <span
          class="show"
          v-for="mode in productlist.recomand.XIANGGUANTIJAIN"
          :key="mode.id"
        >{{mode.name}}</span>
      </div>
    </div>
    <div class="div_border">
      ...
      <el-row v-if="isMponentHide">
        <el-col :span="23">
          <div class="summary">
            <el-popover
              ...
              width="400"
              trigger="hover"
              v-for="model in productlist.recomand.GOUCHENGQIJIAN"
              :key="model.id"
            >
              <div>
        ...
        <el-col :span="1" v-if="productlist.recomand.GOUCHENGQIJIAN.length>0">
          <!-- 绑定点击事件onShow，点击展开全文 -->
    ...
    <div class="div_border">
      ...
      <el-row v-if="isFaultHide">
        <el-col :span="23">
          <div class="summary">
            <el-popover
              ...
              width="400"
              trigger="hover"
              v-for="model in productlist.recomand.GUZHANXIANXIANG"
              :key="model.id"
            >
              <div>
                <span v-for="m in model.data" :key="m.id">{{m.name}}</span>
        ...
        <el-col :span="1" v-if="productlist.recomand.GUZHANXIANXIANG.length>0">
    ...
    <div v-for="item in productlist.content" :key="item.id">
