  ...
  <div>
    <div class="div_border">
      ...
      <div class="marginBootom">
        <span
          class="show"
          v-for="mode in qualityproblemlist.recomand.XIANGGUANTIJAIN"
          :key="mode.id"
        >{{mode.name}}</span>
      </div>
    </div>
    <div class="div_border">
      ...
      <el-row v-if="isMponentHide">
        <el-col :span="23">
          <div class="summary">
            <el-popover
              ...
              width="400"
              trigger="hover"
              v-for="model in qualityproblemlist.recomand.GOUCHENGQIJIAN"
              :key="model.id"
            >
              <div>
        ...
        <el-col :span="1" v-if="qualityproblemlist.recomand.GOUCHENGQIJIAN.length>0">
          <!-- 绑定点击事件onShow，点击展开全文 -->
      ...
      <el-row v-else>
        ...
        <el-col :span="1" v-if="qualityproblemlist.recomand.GUZHANXIANXIANG.length>0">
        ...
        <el-col :span="23">
          <div class="summary">
            <el-popover
              ...
              width="400"
              trigger="hover"
              v-for="model in qualityproblemlist.recomand.GUZHANXIANXIANG"
              :key="model.id"
            >
              <div>
                <span v-for="m in model.data" :key="m.id">{{m.name}}</span>
    ...
    <div v-for="item in qualityproblemlist.content" :key="item.id">
