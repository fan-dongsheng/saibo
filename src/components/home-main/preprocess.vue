...
<el-tag
  ...
  {{tag.name}}
    ...
    <el-table-column label="操作">
     <template slot-scope="scope">
       <el-button type="primary" size="small" @click="handleEdit(scope.$index, scope.row)">确定</el-button>
  ...
  methods:{
    ...
    relationSave(){
      console.log(this.relaArry);
        this.$ajax({
          url: `/hehe/saverelation?file_path=${this.file_path}&scheme=${JSON.stringify(this.relaArry)}`,
          // params:{
